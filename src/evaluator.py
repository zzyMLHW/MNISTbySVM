...
class Evaluator:
    ...
    def evaluate(self, y_true: np.ndarray, y_pred: np.ndarray, y_proba: np.ndarray) -> EvaluationResult:
        # 准确率
        ...
        class_auc, micro_auc, macro_auc, roc_micro_macro_path, roc_per_class_path = self._plot_roc(y_true_bin, y_proba)
